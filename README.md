...
2. Open terminal and navigate to terraform/chef-automate
3. okta_aws solutions-architects
4. terraform apply --auto-approve
5. After finished plug in values to terraform.tfvars in terraform/aws/terraform.tfvars file
6. cd terraform/aws
7. terraform apply --auto-approve
8. Open national parks website: <DNS name>:8080/national-parks
9. Open builder site and show off package
10. Time to update the package
11. Update plan.sh file 
12. Update index.html file (be sure version number is upgraded)
13. cd to root of directory
14. Hab studio enter (explain clean room)
15. build
16. hab pkg upload results/
17. Navigate to bldr and promote package to stable channel
18. Refresh website
